...
from accounting.models import MCapital, MDrawings, MSalesRevenue, MSuppliesExpense, MUtilitiesExpense, MTravelExpense, MDeliveryExpense, MCapital, MDrawings, MRentExpense, MSalaryExpense
'''
Revenue
'''
#Sales Revenue
